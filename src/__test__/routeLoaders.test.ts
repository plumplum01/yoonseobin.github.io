...
describe('route loaders', () => {
  ...
  it('normalizes missing post documents into notFound errors', async () => {
    mockedLoadPost.mockRejectedValue(new Error('Invalid post payload: post document is missing'))
  ...
  it('normalizes invalid CMS payloads into contentInvalid errors', async () => {
    mockedLoadPosts.mockRejectedValue(new Error('Invalid post payload: post.title must be a string'))
